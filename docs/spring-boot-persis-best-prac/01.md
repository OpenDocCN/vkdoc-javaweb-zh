...
*   发送Hibernate信号以保持顺序。在后台，Hibernate 将通过一个`LinkedHashSet`来保存顺序。
...
[Hibernate弹簧靴命名存根图](https://github.com/AnghelLeonard/Hibernate-SpringBoot/tree/master/HibernateSpringBootNamedSubgraph)
