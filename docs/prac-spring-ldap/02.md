...
![9781430263975_Fig02-01.jpg](images/9781430263975_Fig02-01.jpg)
...
![image](images/sq.jpg) **注意**OpenDJ LDAP 服务器支持特殊的子树删除控件，当附加到删除请求时，可以使服务器删除非叶条目及其所有子条目。我们将在第 7 章的[中了解 LDAP 控件的使用](07.html)。
