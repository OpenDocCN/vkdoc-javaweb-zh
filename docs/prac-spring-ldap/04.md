...
![image](images/sq.jpg) **注**注这里讨论的概念是 LdapUnit 开源项目的基础。在以后的章节中，您将使用 LdapUnit 来测试代码。请访问[http://ldapunit.org](http://ldapunit.org)下载项目工件并浏览完整的源代码。
...
destroyInstance 的实现在[清单 4-10](#list10) 中提供。它只需要清理创建的上下文并停止嵌入式服务器。
...
![9781430263975_Fig04-01.jpg](images/9781430263975_Fig04-01.jpg)
