...
![images](img/square.jpg) **注意**你可以在文件 *[第六章](#ch6)/orajavsec/Oracle javasecure . Java .*中找到这段代码
...
![images](img/square.jpg) **注**你可以在文件*[chapter 6](#ch6)/orajavsec/Oracle javasecure . Java*中找到这段代码。

#### 使用密码密钥解密数据

在客户端应用调用了`p_get_des_crypt_test_data`过程之后，我们让他们调用[清单 6-14](#list_6_14) 中所示的方法`getDecryptData()`。
