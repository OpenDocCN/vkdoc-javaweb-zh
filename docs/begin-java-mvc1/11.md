...
日志 API 规范 JSR 47 是 Java 的一部分，可以被任何 Java 程序使用，包括 Jakarta EE 服务器应用程序，当然还有 Java MVC 程序。您可以从 [`https://jcp.org/en/jsr/detail?id=47`](https://jcp.org/en/jsr/detail%253Fid%253D47) 下载该规范。
