...
注意，切入点引用了之前定义的名为“remote”的切入点。更多详情请参见第 [5](05.html) 章。
...
如果在 Spring 应用程序中作为配置启用(通过组件扫描或其他方式)，这个类将使 Spring 读取两个文件“spring-context1.xml”和“spring-context2.xml”，作为 Spring XML 配置。
