...
*   `integrationgraph`–显示Spring积分图。需要依赖 spring-integration-core
...
![img/498572_1_En_16_Figa_HTML.jpg](img/498572_1_En_16_Figa_HTML.jpg)确保你已经将致动器配置为暴露(如本章前面所解释的)并且将Spring Security配置为允许你访问该端点(参见第 [9 章](09.html))。
