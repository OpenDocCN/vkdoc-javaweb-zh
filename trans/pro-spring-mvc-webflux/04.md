...
![img/300017_2_En_4_Figd_HTML.jpg](img/300017_2_En_4_Figd_HTML.jpg)使用这个特性会影响应用程序的启动时间！首先，servlet 容器需要扫描所有`javax.servlet.ServletContainerInitializer`实现的类路径。其次，扫描类路径中的`org.springframework.web.WebApplicationInitializer`实现。在大型应用程序中，这种扫描可能需要一些时间。
