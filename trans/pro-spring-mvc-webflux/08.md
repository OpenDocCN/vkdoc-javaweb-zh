...
百里香发动机通过`org.thymeleaf.spring5.templateresolver.SpringResourceTemplateResolver`和`org.thymeleaf.spring5.SpringTemplateEngine`两种类型与 Spring 框架轻松集成(见表 [8-6](#Tab6) )。需要一个`SpringResourceTemplateResolver` bean 来支持百里香模板资源。
