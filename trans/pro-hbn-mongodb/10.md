...
此外，您需要添加一些属性来帮助 JBoss AS 定位和使用`org.hibernate:ogm`模块，如第 4 章中的[所述，在“*在内置的 JTA 环境中Hibernate OGM(EJB 3，JBoss AS 7)* 一节中:”](04.html)
...
要解决这个问题，您需要授予自己对应用文件和目录的某些权限。打开一个新的 SSH 会话(不要关闭监视 GlassFish 启动/停止状态的会话)，并键入以下`chmod`命令(也显示在[图 10-77](#Fig77) 中)。
