...
![image](img/sq.jpg) **注意**根据我提到的限制，很容易得出结论，MongoDB 不能满足我们应用程序的需求。但是，让我们考虑一下为什么我们会得出这样的结论。我们是否过于沉迷于复杂的数据库模式设计，有许多需要事务的连接和表，以及难以编写和管理的查询？在这里讨论这些问题远不是我的目的，但是也许你会花一点时间去思考它们，并为你的应用找到正确的答案。
