...
我们的应用只是接受无效的尝试并返回一个 OK 状态。这是错误的；我们不应该将这种尝试传递给服务层，而应该在表示层拒绝它。为此，我们将使用与 Spring 集成的 Java Bean 验证 API ( [`https://tpd.io/bean-validation`](https://tpd.io/bean-validation) )。
